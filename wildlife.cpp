...
cout <<"Wildlife class obtained by using setters is: " << w1.GetSpecies()<< "  " << w1.GetName()<<" \nThe nr of  animals in the species : "<<w1.GetNr()<< "\n";
w1.Warning();

Wildlife w2;
cout <<"\nWildlife class obtained by using implicit constructor is: "<< w2.GetSpecies()<< "  " << w2.GetName()<<"\nThe nr of animals in the species:  "<< w2.GetNr()<< "\n";
w2.Warning();
...
cout <<"\nWildlife class attributes entered by keyboar are: "<< w3.GetSpecies()<< "  " << w3.GetName()<<"\nThe nr of  animals in the species : "<<w3.GetNr()<< "\n";
w3.Warning();
return 0;
}
